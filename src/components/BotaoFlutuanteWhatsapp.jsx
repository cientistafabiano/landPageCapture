...
export default function BotaoFlutuanteWhatsapp() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-success text-white shadow-lg hover:bg-success-dark transition-colors"
    >
